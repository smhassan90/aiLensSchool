  ...
  return (
    <Card className={cn(dimmed && "opacity-60")}>
      <CardHeader className="pb-2">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1 space-y-2">
            ...
            <CardTitle className="break-words text-base font-medium leading-6">
      ...
      <CardContent className="space-y-3 text-sm">
            ...
            {options.map((opt, i) => {
              ...
              return (
                ...
                >
                  ...
                  {correct ? <Badge variant="success" className="shrink-0">Correct</Badge> : null}
                </li>
              );
            })}
          </ul>
        ...
        {answer ? (
          <p className="break-words rounded-md border border-emerald-200 bg-emerald-50 px-3 py-2 text-emerald-950">
