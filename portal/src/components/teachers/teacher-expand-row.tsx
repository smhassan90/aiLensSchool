  ...
  return (
    <div className="relative h-24 w-24 shrink-0">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="mt-0.5 text-xs uppercase tracking-wide text-muted-foreground">of 100</span>
      </div>
    </div>
  );
}
      ...
      {weights.map((item) => {
        ...
        return (
          <div
            ...
            title={item.why}
          >
            <p className="truncate text-xs font-medium text-slate-600">{SHORT_LABEL[item.key]}</p>
  ...
  return (
    <>
      ...
      <div className="hidden overflow-hidden rounded-xl border sm:block">
        <div className="grid grid-cols-[1.2fr_0.9fr_repeat(4,0.55fr)] gap-0 bg-slate-900 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-slate-300">
          <span>Class</span>
          <span>Subject</span>
          <span>Term</span>
          <span>Quiz</span>
      ...
      <div className="grid gap-4 p-4 lg:grid-cols-2">
          ...
          <ol className="mt-2 space-y-2">
            {points.map((item, index) => (
              <li key={item} className="flex gap-2 text-sm leading-snug">
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-amber-100 text-xs font-semibold text-amber-900">
                  {index + 1}
                </span>
                {item}
              </li>
        ...
        <div>
          ...
          <div className="mt-4 rounded-xl bg-slate-900 p-3 text-white">
            <p className="text-xs uppercase tracking-wide text-slate-400">Say this</p>
