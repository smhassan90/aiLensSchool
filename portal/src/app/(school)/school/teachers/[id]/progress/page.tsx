    ...
    <div className="p-4 sm:p-6 lg:p-8">
        ...
        actions={
          <div className="flex gap-2">
            <Link href={`/school/teachers/${params.id}`}>
              <Button variant="outline">Teacher details</Button>
            </Link>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <p className={cn("text-lg font-semibold", scoreTextClass(total))}>{total}</p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-lg font-semibold">{facts?.metrics.annual.average ?? "—"}%</p>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-lg font-semibold">{facts?.metrics.studentAttendance.rate ?? "—"}%</p>
