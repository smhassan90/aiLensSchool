export const STAFF_PERMISSIONS = [
  ...
  { key: 'VIEW_BIOMETRIC_DEVICES', label: 'Biometric devices', hint: 'View ZKTeco setup, device users, and mappings' },
  { key: 'MANAGE_BIOMETRIC_DEVICES', label: 'Manage biometric devices', hint: 'Add devices, sync API key, and map device users to teachers' },
  { key: 'VIEW_TEACHER_ATTENDANCE_HISTORY', label: 'Teacher attendance history', hint: 'Date-range reports for teacher check-in and check-out' },
  { key: 'MANAGE_TEACHER_ATTENDANCE', label: 'Manual teacher attendance', hint: 'Manual check-in and check-out overrides' },
